...
The content (post, article, tutorial, project, review, etc.) can be organized within different [listings](https://quarto.org/docs/websites/website-listings.html) on any page. There are three different listing types: default, table, and grid. To add listings to a page, you'll need to edit the yml and create a listing block where you want the list to render. 
...
To render the list, you'll need to include a reference with the id in the document:
